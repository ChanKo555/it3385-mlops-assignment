...
if prediction_type == "Single":
    ...
    year = st.number_input("Year (The year or edition of the model) (1998-2019)", min_value=1998, max_value=2019, step=1)
    ...
    seats = st.number_input("Seats (The number of seats in the car) (1-10 inclusive)", min_value=1, max_value=10, step=1)
...
# Batch Prediction
    ...
    st.write("- Fuel_Type should be one of: Petrol, Diesel, Electric, CNG, LPG")
    st.write("- Transmission should be one of: Automatic, Manual")
    st.write("- Owner_Type should be one of: First, Second, Third, Fourth & Above")
